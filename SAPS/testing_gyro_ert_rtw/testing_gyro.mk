###########################################################################
## Makefile generated for Simulink model 'testing_gyro'. 
## 
## Makefile     : testing_gyro.mk
## Generated on : Tue Nov 15 16:34:40 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testing_gyro
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testing_gyro_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testing_gyro
...
DEFINES_STANDARD = -DMODEL=testing_gyro -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/testing_gyro_ert_rtw/testing_gyro.c $(START_DIR)/testing_gyro_ert_rtw/testing_gyro_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_button.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_lcd.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/MW_legoev3init.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c

MAIN_SRC = $(START_DIR)/testing_gyro_ert_rtw/ert_main.c
...
OBJS = testing_gyro.o testing_gyro_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_gyro_sensor.o
...
%.o : $(START_DIR)/testing_gyro_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/testing_gyro_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

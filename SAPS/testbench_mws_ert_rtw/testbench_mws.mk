###########################################################################
## Makefile generated for Simulink model 'testbench_mws'. 
## 
## Makefile     : testbench_mws.mk
## Generated on : Tue Nov 08 12:00:25 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testbench_mws
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testbench_mws_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testbench_mws
...
INCLUDES_BUILDINFO = -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/testbench_mws_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_SOURCE_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=testbench_mws -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_RTT_LCD_=2
...
DEFINES_STANDARD = -DMODEL=testbench_mws -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = testbench_mws.o testbench_mws_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_motor.o
...
%.o : $(START_DIR)/testbench_mws_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/testbench_mws_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

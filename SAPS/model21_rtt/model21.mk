# File name: model21.mk
# Autogenerated on: 18-Oct-2016 16:44:33
...
SOURCE_FILES        := $(call FORMAT_PATH,.\driver_ev3_gyro_sensor.c) $(call FORMAT_PATH,.\driver_ev3_lcd.c) $(call FORMAT_PATH,.\driver_ev3_motor.c) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\model21.c) $(call FORMAT_PATH,.\model21_data.c)
HEADER_FILES        := $(call FORMAT_PATH,.\model21.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/legomindstormsev3/toolbox/realtime/targets/ev3/include" -I"E:/Dropbox/Dropbox/ESDProject/SAPS/model21_rtt" -I"E:/Dropbox/Dropbox/ESDProject/SAPS" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/extern/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/simulink/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/ert" -D"MODEL=model21" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0"

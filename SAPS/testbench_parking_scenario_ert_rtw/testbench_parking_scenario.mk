###########################################################################
## Makefile generated for Simulink model 'testbench_parking_scenario'. 
## 
## Makefile     : testbench_parking_scenario.mk
## Generated on : Sun Nov 13 22:10:23 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testbench_parking_scenario
...
PRODUCT_NAME              = testbench_parking_scenario
MAKEFILE                  = testbench_parking_scenario.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testbench_parking_scenario_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testbench_parking_scenario
...
INCLUDES_BUILDINFO = -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/testbench_parking_scenario_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_SOURCE_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=testbench_parking_scenario -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = testbench_parking_scenario.o testbench_parking_scenario_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_motor.o
...
%.o : $(START_DIR)/testbench_parking_scenario_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/testbench_parking_scenario_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

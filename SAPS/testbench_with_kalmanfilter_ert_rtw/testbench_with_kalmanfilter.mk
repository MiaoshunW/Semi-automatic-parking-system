###########################################################################
## Makefile generated for Simulink model 'testbench_with_kalmanfilter'. 
## 
## Makefile     : testbench_with_kalmanfilter.mk
## Generated on : Tue Nov 29 16:21:32 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testbench_with_kalmanfilter
...
PRODUCT_NAME              = testbench_with_kalmanfilter
MAKEFILE                  = testbench_with_kalmanfilter.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testbench_with_kalmanfilter_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testbench_with_kalmanfilter
...
INCLUDES_BUILDINFO = -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/testbench_with_kalmanfilter_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_SOURCE_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=testbench_with_kalmanfilter -DNUMST=3 -DNCSTATES=4 -DHAVESTDIO -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=testbench_with_kalmanfilter -DNUMST=3 -DNCSTATES=4 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/rtGetInf.c $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/rtGetNaN.c $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/rt_nonfinite.c $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/testbench_with_kalmanfilter.c $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/testbench_with_kalmanfilter_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_button.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_lcd.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/MW_legoev3init.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_encoder.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_motor.c

MAIN_SRC = $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/testbench_with_kalmanfilter_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
driver_ev3_gyro_sensor.o : /Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c
	$(CC) $(CFLAGS) -o "$@" "$<"

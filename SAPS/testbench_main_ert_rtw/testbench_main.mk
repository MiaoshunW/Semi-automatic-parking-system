###########################################################################
## Makefile generated for Simulink model 'testbench_main'. 
## 
## Makefile     : testbench_main.mk
## Generated on : Tue Nov 22 16:22:00 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/testbench_main
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/karanverma/Dropbox/ESDProject/SAPS
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = testbench_main_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/testbench_main
...
INCLUDES_BUILDINFO = -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/testbench_main_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=testbench_main -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=testbench_main -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/testbench_main_ert_rtw/rtGetInf.c $(START_DIR)/testbench_main_ert_rtw/rtGetNaN.c $(START_DIR)/testbench_main_ert_rtw/rt_nonfinite.c $(START_DIR)/testbench_main_ert_rtw/testbench_main.c $(START_DIR)/testbench_main_ert_rtw/testbench_main_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_button.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_lcd.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/MW_legoev3init.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_encoder.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_motor.c

MAIN_SRC = $(START_DIR)/testbench_main_ert_rtw/ert_main.c
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o testbench_main.o testbench_main_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_gyro_sensor.o driver_ev3_motor.o
...
%.o : $(START_DIR)/testbench_main_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/testbench_main_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
driver_ev3_encoder.o : /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_encoder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


driver_ev3_gyro_sensor.o : /Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c
	$(CC) $(CFLAGS) -o "$@" "$<"

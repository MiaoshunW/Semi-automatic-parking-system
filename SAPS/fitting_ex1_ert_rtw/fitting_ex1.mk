###########################################################################
## Makefile generated for Simulink model 'fitting_ex1'. 
## 
## Makefile     : fitting_ex1.mk
## Generated on : Tue Nov 22 18:21:42 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fitting_ex1
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = fitting_ex1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fitting_ex1
...
INCLUDES_BUILDINFO = -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/fitting_ex1_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_SOURCE_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=fitting_ex1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = fitting_ex1.o fitting_ex1_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_motor.o driver_ev3_ultrasonic_sensor.o
...
%.o : $(START_DIR)/fitting_ex1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/fitting_ex1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

###########################################################################
## Makefile generated for Simulink model 'model21'. 
## 
## Makefile     : model21.mk
## Generated on : Wed Oct 26 14:25:25 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/model21
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = model21_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/model21
...
INCLUDES_BUILDINFO = -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/model21_ert_rtw -I$(START_DIR) -I/Users/Shobhit/Dropbox/ESDProject/SAPS -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_SOURCE_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/Shobhit/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=model21 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = model21.o model21_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_motor.o driver_ev3_ultrasonic_sensor.o
...
%.o : $(START_DIR)/model21_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/model21_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

###########################################################################
## Makefile generated for Simulink model 'gyro'. 
## 
## Makefile     : gyro.mk
## Generated on : Tue Nov 15 16:39:29 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gyro
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = gyro_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gyro
...
INCLUDES_BUILDINFO = -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/gyro_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=gyro -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = gyro.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_gyro_sensor.o

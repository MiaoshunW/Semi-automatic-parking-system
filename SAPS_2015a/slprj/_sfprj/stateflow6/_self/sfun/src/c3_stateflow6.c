    ...
    *chartInstance->c3_state_nr = 1.0;
    ...
    switch (*chartInstance->c3_ChartMode) {
     ...
     case ChartModeType_Park_Space:
      ...
      guard9 = false;
      guard10 = false;
      if (CV_EML_COND(2, 0, 0, *chartInstance->c3_UltrSnsr < 44.0)) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1382894256U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2664286156U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1654090871U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1159446402U);
}
...
mxArray *sf_c3_stateflow6_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("SyvLIbOKcLNbR6kHVT3LCC");
...
{
  return "svktyggVG3347U4O8L2a2SG";
}
...
static void mdlSetWorkWidths_c3_stateflow6(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1477038684U));
  ssSetChecksum1(S,(2580558722U));
  ssSetChecksum2(S,(1147317376U));
  ssSetChecksum3(S,(43308601U));

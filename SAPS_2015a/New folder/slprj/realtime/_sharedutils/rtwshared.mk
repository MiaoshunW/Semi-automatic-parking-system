...
# Autogenerated on: 04-Jan-2017 19:43:59
...
SOURCE_FILES        := $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c) $(call FORMAT_PATH,.\rtGetInf.c) $(call FORMAT_PATH,.\rtGetNaN.c) $(call FORMAT_PATH,.\rt_nonfinite.c) $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c)
HEADER_FILES        := $(call FORMAT_PATH,.\rtGetInf.h) $(call FORMAT_PATH,.\rtGetNaN.h) $(call FORMAT_PATH,.\rt_nonfinite.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/legomindstormsev3/toolbox/realtime/targets/ev3/include" -I"C:/Users/USER/Dropbox/ESDProject/SAPS_2015a/New folder/stateflow6_rtt" -I"C:/Users/USER/Dropbox/ESDProject/SAPS_2015a/New folder" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/extern/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/simulink/include" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/ert" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/toolbox/coder/rtiostream/src/utils" -I"C:/Users/USER/Dropbox/ESDProject/SAPS_2015a/New folder/slprj/realtime/_sharedutils" -I"C:/Program Files/MATLAB/MATLAB Production Server/R2015a/rtw/c/src/rtiostream/rtiostreamtcpip" -D"EXT_MODE=" -D"EXIT_FAILURE=1" -D"EXTMODE_DISABLEPRINTF=" -D"EXTMODE_DISABLETESTING=" -D"EXTMODE_DISABLE_ARGS_PROCESSING=1"
...
LINKER_CODEGEN_ARGS   := 
LINKER_TCCFG_ARGS     := -crs $(TARGET_FILE)
...
LINKER             ?= $(subst \,/,C:\MATLAB\SupportPackages\R2015a\CodeSourcery\bin\arm-none-linux-gnueabi-ar)
PREBUILD_TOOL      ?= 
POSTBUILD_TOOL     ?= 

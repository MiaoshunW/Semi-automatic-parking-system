###########################################################################
## Makefile generated for Simulink model 'detection'. 
## 
## Makefile     : detection.mk
## Generated on : Mon Dec 05 19:00:35 2016
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/detection
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = detection_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/detection
...
INCLUDES_BUILDINFO = -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/detection_ert_rtw -I$(START_DIR) -I/Users/karanverma/Dropbox/ESDProject/SAPS_2016b -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/karanverma/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_STANDARD = -DMODEL=detection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = detection.o ext_svr.o updown.o ext_work.o rtiostream_utils.o linuxinitialize.o rtiostream_interface.o rtiostream_tcpip.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_encoder.o driver_ev3_motor.o
...
%.o : $(START_DIR)/detection_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/detection_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
